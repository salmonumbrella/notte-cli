...
<body>
    ...
    <div class="container">
        ...
        <div class="logo-section fade-in">
            ...
            <p class="subtitle">Authenticate your CLI with your API key</p>
        </div>
        ...
        <div class="card fade-in">
            ...
            <div class="help-section">
                <div class="help-title">How to get your API key</div>
                <div class="help-steps">
                    <div class="help-step">
                        <span class="help-num">1</span>
                        <span>Sign in to console.notte.cc</span>
                    </div>
                    <div class="help-step">
        ...
        <div class="footer fade-in">
            <a href="https://notte.cc/docs" target="_blank">Documentation</a>
            &nbsp;&middot;&nbsp;
            <a href="https://github.com/salmonumbrella/notte-cli" target="_blank">GitHub</a>
        </div>
    </div>
